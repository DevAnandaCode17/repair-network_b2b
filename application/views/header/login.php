...
<html>
    <head>
        ...
        <title>Repair Network CRM | Log in</title>
        ...
        <!-- Custom style -->
        <link rel="stylesheet" href="<?php echo base_url() ?>vendors/css/custom.css">
    ...
    <body class="hold-transition login-page custom-login login-background">